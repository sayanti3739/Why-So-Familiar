document.getElementById("searchButton").addEventListener("click", async function() {
        ...
        if (response.ok) {
            ...
            // document.getElementById('tokenOutput').textContent = data.bearerToken;
        ...
        try {
            ...
            //              --- how will you handle if there are multiple characters with the same (say) first name ?
            ...
            // 5) what about the case when the input series/movie doesn't exist?
